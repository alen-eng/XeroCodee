...
function login() {
  ...
  const handleLogin = async (event: React.FormEvent<HTMLFormElement>) => {
      ...
      handler(email,password).then((res)=>{
         const result =JSON.parse(JSON.stringify(res))
  ...
  return (
    ...
    <span className="flex-shrink mx-1 text-xs font-bold text-gray-400">Login to Your Account</span>
    <div className="flex-grow border-t border-gray-400"></div>
</div>
          ...
          <div className="flex justify-center my-2">
             ...
             <div className="flex flex-col items-center">
                ...
                flex-1" />
                 ...
                 <p className='text-sm pb-1 pt-8'>Don't have an account ? <Link className='text-[#1F64FF] font-normal' href={'/signup'}>SIGNUP</Link></p>
             </div>
             </form>
          </div>       
      </div>
